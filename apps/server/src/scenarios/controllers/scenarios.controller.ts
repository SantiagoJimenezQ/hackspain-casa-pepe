...
export class ScenariosController {
	...
	@ApiOperation({
		summary:
			"Available scenarios with their language. Pass the identifier to POST /demo/start",
	})
	...
	@ApiOperation({
		summary:
			"Full scenario definition: services, dependencies, capacity, facts, engineer briefing and twist",
	})
	getByIdentifier(
