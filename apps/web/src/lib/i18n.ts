...
const es = {
  ...
  "agent.discarded": "{count} intentos descartados",

  "map.networkLive": "Red operativa",
  "map.networkCrisis": "Golfo · failover activo",
  "map.networkRestored": "Red restaurada",
  "map.topologyTitle": "Topología operativa",
  "map.servicesCount": "{count} servicios",
  "map.impactBadge": "IMPACTO",
  ...
  "tool.wait_for_input.done": "Esperó a que llegaran novedades",
  ...
  "agent.decisionTree": "Árbol de decisiones",
  "agent.openDecisionTree": "Abrir árbol de decisiones",
  "agent.scrollToLatest": "Ir al último",
  "agent.workLabel": "Trabajo del agente",
  "error.eyebrow": "Casa Pepe · Centro de mando",
  "error.title": "No se puede alcanzar al coordinador",
  "error.body": "No se pudo contactar con el backend de Casa Pepe.",
  "error.retry": "Reintentar",
  "empty.agent.verb1": "Listo para llamar al ingeniero de guardia",
  "empty.agent.verb2": "Listo para medir la capacidad de respaldo",
  "empty.agent.verb3": "Listo para priorizar a los clientes",
  "empty.agent.verb4": "Listo para redactar el plan de recuperación",
  "empty.agent.verb5": "Listo para ejecutar el failover",
  "empty.agent.verb6": "Listo para avisar a los clientes afectados",
  "empty.agent.title": "Pepe está en espera",
  "empty.agent.hint": "Pulsa Impacto para lanzar el incidente. Cada decisión, llamada y recuperación irá apareciendo aquí en directo.",
  "empty.recovery.title": "Ninguna recuperación todavía",
  "empty.recovery.hint": "Los {count} servicios irán apareciendo aquí según el agente los recupere y los verifique.",
  "agent.thinking": "Pensando",
  "agent.thought": "Pensó {duration}",
  "agent.idle": "En espera",
  "agent.disposition.pending": "Validando",
  "agent.disposition.rejected": "Rechazado",
  "agent.disposition.stale": "Obsoleto",
  "agent.disposition.incomplete": "Incompleto",
  "agent.proposal.rejected": "Propuesta rechazada",
  "agent.proposal.stale": "Propuesta obsoleta",
  "agent.proposal.incomplete": "Respuesta incompleta",
  "topbar.resolved": "Resuelto",
  "topbar.incidentTime": "Tiempo de incidente",
  "topbar.resolvedLabel": "Incidente resuelto",
  "topbar.sinceImpact": "Tiempo desde el impacto",
  "topbar.impact": "Impacto",
  "topbar.impactHint": "Dispara el impacto del incidente y arranca al agente",
  "topbar.twist": "Recortar capacidad",
  "topbar.twistHint": "Plataforma informa de la capacidad real: el respaldo baja a una unidad",
  "topbar.clearLearnings": "Borrar aprendizajes",
  "topbar.clearingLearnings": "Borrando aprendizajes…",
  "topbar.clearLearningsHint": "Borra todos los aprendizajes guardados de ejecuciones anteriores. No reinicia el incidente actual.",
  "topbar.reset": "Reiniciar",
  "topbar.resetHint": "Reinicia la demo al estado inicial",
  "topbar.liveActivity": "ACTIVIDAD EN DIRECTO",
  "topbar.standby": "EN ESPERA",
  "topbar.subtitle": "Coordinación de incidentes",
  "tree.milestones": "{count} hitos · {changes} cambios de plan",
  "tree.loadingHistory": "· Cargando historial…",
  "tree.partialHistory": "· Historial parcial",
  "tree.live": "· En directo",
  "tree.summaryTab": "Resumen",
  "tree.detailTab": "Detalle",
  "tree.pause": "Pausar",
  "tree.play": "Reproducir recorrido",
  "tree.retry": "Reintentar",
  "tree.errorSuffix": "Se muestran los eventos disponibles.",
  "tree.loadingJourney": "Cargando el recorrido",
  "tree.awaitingFirst": "Esperando la primera decisión",
  "tree.emptyHint": "Las señales, los planes y sus resultados aparecerán aquí.",
  "tree.legend.priority": "Prioridad del plan",
  "tree.legend.time": "Orden temporal",
  "tree.legend.revision": "Cambio de plan",
  "tree.legend.note": "Las líneas temporales no implican causalidad.",
  "tree.selectHint": "Selecciona un hito para ver sus motivos y su origen.",
  "tree.planPriority": "Prioridad del plan",
  "tree.recordedReason": "Motivo registrado",
  "tree.contextChanges": "Contexto y cambios",
  "tree.sourceEvent": "Ver evento de origen",
  "tree.sourceType": "Tipo",
  "tree.sourceIdentifier": "Identificador",
  "tree.sourceDate": "Fecha",
  "tree.sourceSequence": "Secuencia",
  "tree.sourceMode": "Modo",
  "tree.simulated": "Simulado",
  "tree.notSimulated": "No marcado como simulado",
  "tree.replayed": " · Reproducción",
  "tree.fit": "Ajustar",
  "tree.footnote": "Solo información registrada en esta ejecución. Una propuesta validada no implica que la acción se haya completado.",
  "tree.kind.signal": "Señal",
  "tree.kind.decision": "Decisión",
  "tree.kind.plan": "Plan inicial",
  "tree.kind.revision": "Cambio de plan",
  "tree.kind.action": "Acción",
  "tree.kind.result": "Resultado",
  "tree.status.signal": "Señal registrada",
  "tree.status.planSaved": "Plan guardado",
  "tree.status.planRevised": "Plan revisado",
  "tree.status.actionDone": "Acción completada",
  "tree.status.actionFailed": "Acción fallida",
  "tree.status.result": "Resultado registrado",
  "tree.status.approvalOverridden": "Aprobación anulada",
  "tree.status.humanDecision": "Intervención humana",
  "tree.decision.recover-now": "Recuperar ahora",
  "tree.decision.postpone": "Aplazado",
  "tree.decision.already-healthy": "Ya operativo",
  "tree.decision.waiting-for-dependency": "Esperando una dependencia",
  "tree.decision.recorded": "Registrado",
  "tree.proposal.accepted": "Propuesta validada",
  "tree.proposal.rejected": "Propuesta rechazada",
  "tree.proposal.stale": "Propuesta desactualizada",
  "tree.proposal.incomplete": "Respuesta incompleta",
  "tree.proposal.pending": "Pendiente de validación",
  "tree.proposal.other": "Decisión registrada",
  "tree.title.incident.impact-detected": "Impacto detectado",
  "tree.title.incident.event-applied": "Cambio en el entorno",
  "tree.title.resource.capacity-changed": "Capacidad comprometida",
  "tree.title.fact.recorded": "Hecho registrado",
  "tree.title.engineer-call.incoming": "Llamada entrante",
  "tree.title.recovery.executed": "Recuperación ejecutada",
  "tree.title.recovery.verified": "Recuperación verificada",
  "tree.service": "Servicio",
  "tree.noExplanation": "Sin explicación registrada.",
...
const en: { [K in keyof typeof es]: string } = {
  ...
  "agent.discarded": "{count} discarded attempts",

  "map.networkLive": "Operational network",
  "map.networkCrisis": "Gulf · failover active",
  "map.networkRestored": "Network restored",
  "map.topologyTitle": "Operational topology",
  "map.servicesCount": "{count} services",
  "map.impactBadge": "IMPACT",
  ...
  "tool.wait_for_input.done": "Waited for news to arrive",
  ...
  "agent.decisionTree": "Decision tree",
  "agent.openDecisionTree": "Open the decision tree",
  "agent.scrollToLatest": "Go to the latest",
  "agent.workLabel": "Agent work",
  "error.eyebrow": "Casa Pepe · Command centre",
  "error.title": "The coordinator cannot be reached",
  "error.body": "Casa Pepe's backend did not answer.",
  "error.retry": "Retry",
  "empty.agent.verb1": "Ready to call the on-call engineer",
  "empty.agent.verb2": "Ready to measure the backup capacity",
  "empty.agent.verb3": "Ready to rank the customers by impact",
  "empty.agent.verb4": "Ready to draft the recovery plan",
  "empty.agent.verb5": "Ready to run the failover",
  "empty.agent.verb6": "Ready to notify the affected customers",
  "empty.agent.title": "Pepe is standing by",
  "empty.agent.hint": "Press Impact to start the incident. Every decision, call and recovery will show up here as it happens.",
  "empty.recovery.title": "No recoveries yet",
  "empty.recovery.hint": "The {count} services will appear here as the agent recovers and verifies each one.",
  "agent.thinking": "Thinking",
  "agent.thought": "Thought for {duration}",
  "agent.idle": "Standing by",
  "agent.disposition.pending": "Validating",
  "agent.disposition.rejected": "Rejected",
  "agent.disposition.stale": "Out of date",
  "agent.disposition.incomplete": "Incomplete",
  "agent.proposal.rejected": "Proposal rejected",
  "agent.proposal.stale": "Proposal out of date",
  "agent.proposal.incomplete": "Incomplete answer",
  "topbar.resolved": "Resolved",
  "topbar.incidentTime": "Incident time",
  "topbar.resolvedLabel": "Incident resolved",
  "topbar.sinceImpact": "Time since the impact",
  "topbar.impact": "Impact",
  "topbar.impactHint": "Fires the incident impact and starts the agent",
  "topbar.twist": "Cut capacity",
  "topbar.twistHint": "Platform reports the real capacity: the backup drops to one unit",
  "topbar.clearLearnings": "Clear learnings",
  "topbar.clearingLearnings": "Clearing learnings…",
  "topbar.clearLearningsHint": "Deletes every learning saved from earlier runs. It does not reset the current incident.",
  "topbar.reset": "Reset",
  "topbar.resetHint": "Resets the demo to its initial state",
  "topbar.liveActivity": "LIVE ACTIVITY",
  "topbar.standby": "ON STANDBY",
  "topbar.subtitle": "Incident coordination",
  "tree.milestones": "{count} milestones · {changes} plan changes",
  "tree.loadingHistory": "· Loading history…",
  "tree.partialHistory": "· Partial history",
  "tree.live": "· Live",
  "tree.summaryTab": "Summary",
  "tree.detailTab": "Detail",
  "tree.pause": "Pause",
  "tree.play": "Play the journey",
  "tree.retry": "Retry",
  "tree.errorSuffix": "The available events are shown.",
  "tree.loadingJourney": "Loading the journey",
  "tree.awaitingFirst": "Waiting for the first decision",
  "tree.emptyHint": "Signals, plans and their results will appear here.",
  "tree.legend.priority": "Plan priority",
  "tree.legend.time": "Time order",
  "tree.legend.revision": "Plan change",
  "tree.legend.note": "Time lines do not imply causality.",
  "tree.selectHint": "Pick a milestone to see its reasons and its origin.",
  "tree.planPriority": "Plan priority",
  "tree.recordedReason": "Recorded reason",
  "tree.contextChanges": "Context and changes",
  "tree.sourceEvent": "See the source event",
  "tree.sourceType": "Type",
  "tree.sourceIdentifier": "Identifier",
  "tree.sourceDate": "Date",
  "tree.sourceSequence": "Sequence",
  "tree.sourceMode": "Mode",
  "tree.simulated": "Simulated",
  "tree.notSimulated": "Not marked as simulated",
  "tree.replayed": " · Replay",
  "tree.fit": "Fit",
  "tree.footnote": "Only information recorded in this run. A validated proposal does not mean the action completed.",
  "tree.kind.signal": "Signal",
  "tree.kind.decision": "Decision",
  "tree.kind.plan": "Opening plan",
  "tree.kind.revision": "Plan change",
  "tree.kind.action": "Action",
  "tree.kind.result": "Result",
  "tree.status.signal": "Signal recorded",
  "tree.status.planSaved": "Plan saved",
  "tree.status.planRevised": "Plan revised",
  "tree.status.actionDone": "Action completed",
  "tree.status.actionFailed": "Action failed",
  "tree.status.result": "Result recorded",
  "tree.status.approvalOverridden": "Approval overridden",
  "tree.status.humanDecision": "Human decision",
  "tree.decision.recover-now": "Recover now",
  "tree.decision.postpone": "Postponed",
  "tree.decision.already-healthy": "Already healthy",
  "tree.decision.waiting-for-dependency": "Waiting for a dependency",
  "tree.decision.recorded": "Recorded",
  "tree.proposal.accepted": "Proposal validated",
  "tree.proposal.rejected": "Proposal rejected",
  "tree.proposal.stale": "Proposal out of date",
  "tree.proposal.incomplete": "Incomplete answer",
  "tree.proposal.pending": "Awaiting validation",
  "tree.proposal.other": "Decision recorded",
  "tree.title.incident.impact-detected": "Impact detected",
  "tree.title.incident.event-applied": "Change in the environment",
  "tree.title.resource.capacity-changed": "Capacity committed",
  "tree.title.fact.recorded": "Fact recorded",
  "tree.title.engineer-call.incoming": "Incoming call",
  "tree.title.recovery.executed": "Recovery executed",
  "tree.title.recovery.verified": "Recovery verified",
  "tree.service": "Service",
  "tree.noExplanation": "No explanation recorded.",
